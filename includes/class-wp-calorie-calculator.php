...
class WP_Calorie_Calculator {
	...
	public function get_calculator_default_goals() {
		$goals = array(
			array(
				'name'        => esc_html__( 'Maintain Weight', 'wp-calorie-calculator' ),
				'coefficient' => 1,
			),
			array(
				'name'        => esc_html__( 'Weight Loss', 'wp-calorie-calculator' ),
				'coefficient' => 0.8,
			),
			array(
				'name'        => esc_html__( 'Extreme Weight Loss', 'wp-calorie-calculator' ),
				'coefficient' => 0.6,
			),
			array(
				'name'        => esc_html__( 'Weight Gain', 'wp-calorie-calculator' ),
				'coefficient' => 1.2,
			),
			array(
				'name'        => esc_html__( 'Fast Weight Gain', 'wp-calorie-calculator' ),
				'coefficient' => 1.4,
			),
		);
